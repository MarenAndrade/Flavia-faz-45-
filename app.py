...
def admin_panel():
    ...
    col3.metric("Crianças de 7 a 9 anos", int(confirmed["babies"].sum()) if len(confirmed) else 0)
    col4.metric("Crianças até 6 anos", int(confirmed["children"].sum()) if len(confirmed) else 0)
    ...
    st.dataframe(display[["Responsável", "Telefone", "Status", "Adultos (10 anos ou mais)", "Crianças de 7 a 9 anos", "Crianças até 6 anos", "Total", "Mensagem"]], use_container_width=True, hide_index=True)
