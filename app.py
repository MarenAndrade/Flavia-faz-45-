...
def admin_panel():
    ...
    col2.metric("Adultos (13 anos ou mais)", int(confirmed["adults"].sum()) if len(confirmed) else 0)
    col3.metric("Crianças (2 a 12 anos)", int(confirmed["children"].sum()) if len(confirmed) else 0)
    col4.metric("Bebês (0 a 1 ano)", int(confirmed["babies"].sum()) if len(confirmed) else 0)
    ...
    display = display.rename(columns={"name": "Responsável", "phone": "Telefone", "adults": "Adultos (13 anos ou mais)", "children": "Crianças (2 a 12 anos)", "babies": "Bebês (0 a 1 ano)", "child_ages": "Idades", "notes": "Mensagem"})
    st.dataframe(display[["Responsável", "Telefone", "Status", "Adultos (13 anos ou mais)", "Crianças (2 a 12 anos)", "Bebês (0 a 1 ano)", "Total", "Mensagem"]], use_container_width=True, hide_index=True)
